  ...
  const hackathons = [
    {
      ...
      achievement: 'Grand Finalist (Top 0.1%)',
      project: 'N.E.W.S Health Monitoring Platform',
      description: 'Competed at national finals among 890,000 students with IoT-based healthcare solution for water-borne disease detection in rural Northeast India.',
      tech: ['React', 'Node.js', 'XGBoost', 'LoRaWAN', 'IoT', 'Healthcare Tech', 'AI/ML'],
      date: '2025',
    ...
    },
    {
      ...
      description: 'Developed full-stack fintech application with real-time data processing and responsive UI in 24 hours. Prioritized mobile-first design and user experience.',
      tech: ['Finance Tech', 'Mobile-First Design', 'Real-time Analytics', 'React', 'User Experience'],
      date: '2025',
      participants: 'Team Event',
      icon: Trophy,
    ...
    },
    {
      ...
      project: 'Collaborative Platform',
      description: 'Built collaborative problem-solving platform with WebSocket integration for real-time communication and seamless teamwork.',
      tech: ['WebSockets', 'Real-time Communication', 'Collaboration', 'Full-Stack'],
      date: '2025',
      participants: 'Team Event',
      icon: Trophy,
    ...
    },
    {
      ...
      achievement: 'Finalist',
      project: 'MedSecure',
      description: 'Created secure medical record exchange platform with end-to-end encryption and compliance features. Implemented HIPAA-compliant security measures.',
      tech: ['Next.js 15', 'TypeScript', 'HIPAA Compliance', 'Healthcare Tech', 'Security', 'Encryption'],
      date: '2025',
      participants: 'Team Event',
      icon: Trophy,
