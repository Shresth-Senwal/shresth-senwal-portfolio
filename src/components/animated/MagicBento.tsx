 ...
 * 
 * A sophisticated animated grid component with particle effects, spotlight interactions,
 * and magnetic hover behaviors. Designed for showcasing content with visual appeal
 * and smooth animations throughout the interface.
 * 
 * Features:
 * - Particle effects on hover
 * - Global spotlight with glow effects
